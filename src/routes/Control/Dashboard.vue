<template>
	<v-row>
		<v-col xs="12" sm="8" md="8" lg="9" xl="9">
			...
			<v-row
			v-show="machineMode == 'Milling Mode'">
				<v-col sm="12" :md="(!isFFForUnset && atxPower !== null) ? 9 : 12" :lg="(!isFFForUnset && atxPower !== null) ? 9 : 12" :xl="(!isFFForUnset && atxPower !== null) ? 10 : 12">
					<movement-Jog-panel></movement-Jog-panel>
				</v-col>
			</v-row>
			<v-row>
				<v-col sm="12" :md="(!isFFForUnset && atxPower !== null) ? 9 : 12" :lg="(!isFFForUnset && atxPower !== null) ? 9 : 12" :xl="(!isFFForUnset && atxPower !== null) ? 10 : 12">
					<Spindle-Odrive></Spindle-Odrive>
				</v-col>
			</v-row>
			<v-row>
				<v-col sm="12" :md="(!isFFForUnset && atxPower !== null) ? 9 : 12" :lg="(!isFFForUnset && atxPower !== null) ? 9 : 12" :xl="(!isFFForUnset && atxPower !== null) ? 10 : 12">
					<!-- <Job-Macro-List></Job-Macro-List> -->
				</v-col>
			</v-row>
			<v-row>
				<v-col sm="12" :md="(!isFFForUnset && atxPower !== null) ? 9 : 12" :lg="(!isFFForUnset && atxPower !== null) ? 9 : 12" :xl="(!isFFForUnset && atxPower !== null) ? 10 : 12">
					<!-- <Check-Spell-Panel></Check-Spell-Panel> -->
				</v-col>
			</v-row>
		</v-col>
