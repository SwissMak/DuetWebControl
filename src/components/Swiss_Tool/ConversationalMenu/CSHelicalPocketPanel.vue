...
export default {
	...
	data() {
		return {
            ...
            CuttingParameters :[
                ...
                {
                    paraname : "Diameter of cutter",
                    datavalue : 10,
                    codetype : "B",
                    unit:"mm",
                },
                {
                    paraname : "Depth of hole",
                    datavalue : 10,
                    codetype : "C",
                    unit:"mm",
                },
                {
                    paraname : "Depth of each helical",
                    datavalue : 1,
                    codetype : "E",
                    unit:"mm",
                },
	...
	methods: {
        ...
        GetFeedrate(){
            return this.CuttingParameters[4].datavalue;
        },
        GetDepthofCut(){
            return this.CuttingParameters[3].datavalue;
        },
        GetSpindleRPM(){
            return this.CuttingParameters[5].datavalue;
        },
        FindParaNameIndex(_value){
            const result = this.CuttingParameters.filter(x => x.paraname == _value);
            if(result)return result[0].datavalue;
            else return 0;
        },
        ...
        CreateGCode(){
            ...
            for(let i=0 ; i< this.XYarray.length ; i++ ){
                ...
                //
                g_code += "M460";
                for(let j=0 ; j< this.CuttingParameters.length ; j++ ){
                    g_code += " " + this.CuttingParameters[j].codetype + String(this.CuttingParameters[j].datavalue);
                }
                g_code += "\n";
            }
        ...
        showcommon(){
            let strcom = ";***Below is Helical Pocket***\n";
