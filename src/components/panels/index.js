...
import AxisGloableVariablePanel from './AxisGloableVariablePanel.vue'
import BLDCParameterSetting from './BLDCParameterSetting.vue'
import ControlModePanel from './ControlModePanel.vue'
import ExtrudePanel from './ExtrudePanel.vue'
import ExtrusionFactorsPanel from './ExtrusionFactorsPanel.vue'
import SpindleOdrive from './Spindle.vue'
import ErrorCodeBLDC from './ErrorCode.vue'
import AboutUS from './AboutUS.vue'
import FanPanel from './FanPanel.vue'
import FansPanel from './FansPanel.vue'
import HeightmapPanel from './HeightmapPanel.vue'
import JobMacroList from './JobMacroList.vue'
import MovementPanel from './MovementPanel.vue'
import RCServoPanel from './RCServoPanel.vue'
...
import ThreeDViewPanel from './ThreeDViewPanel.vue'
import ToolsPanel from './ToolsPanel.vue'
import ToolsPanelDesktop from './ToolsPanelDesktop.vue'
import WebcamPanel from './WebcamPanel.vue'
import ZBabystepPanel from './ZBabystepPanel.vue'
import MovementJogPanel from './MovementJogPanel.vue'

Vue.component('atx-panel', ATXPanel)
Vue.component('Axis-Gloable-Variable-Panel', AxisGloableVariablePanel)
Vue.component('BLDC-Parameter-Setting', BLDCParameterSetting)
Vue.component('Control-Mode-Panel', ControlModePanel)
Vue.component('extrude-panel', ExtrudePanel)
Vue.component('extrusion-factors-panel', ExtrusionFactorsPanel)
Vue.component('Spindle-Odrive', SpindleOdrive)
Vue.component('Error-Code-BLDC', ErrorCodeBLDC)
...
Vue.component('Job-Macro-List', JobMacroList)
Vue.component('movement-panel', MovementPanel)
Vue.component('RCServo-Panel', RCServoPanel)
...
Vue.component('ThreeD-View-Panel', ThreeDViewPanel)
Vue.component('tools-panel', ToolsPanel)
Vue.component('Tools-Panel-Desktop', ToolsPanelDesktop)
Vue.component('webcam-panel', WebcamPanel)
Vue.component('z-babystep-panel', ZBabystepPanel)
Vue.component('movement-Jog-panel', MovementJogPanel)

export default {
	ATXPanel,
	AxisGloableVariablePanel,
	ExtrudePanel,
