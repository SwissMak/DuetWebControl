...
<template>
	<v-app>		
		<v-navigation-drawer v-model="drawer" clipped fixed app temporary width="300">
				...
				<v-container v-show="!hideGlobalContainer || $vuetify.breakpoint.mdAndUp" id="global-container" fluid class="py-0">
					<v-row>
						<v-col cols="12" sm="2" md="2" lg="2" xl="2">
							<Button-Item-Area-Panel></Button-Item-Area-Panel>
						</v-col>
					...
					<v-row>
						<v-col>
							<IO-Control-Panel></IO-Control-Panel>
						</v-col>
...
export default {
	...
	data() {
		return {
			drawer: this.$vuetify.breakpoint.xlOnly,
